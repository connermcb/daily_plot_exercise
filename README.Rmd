...
## The Plots
**Plot 35 - December 12, 2018:** Coplot for looking behind an apparent relationship for anly lurking variables.
...
The chart makes it look like states that spend more on education see lower results on the SATM. Because this doesn't make logical sense, we'll try to slice or facet the data on a third variable.
...
**Plot 34 - November 30, 2018:** Bubble plot of random sample of larger data set that would be too dense to interpret if all points were plotted. From _Graphing Data with R_:
...
PlotBubble( x = Educ, y = AFQT, area = Income2005/1000,
            ...
            cex = 2, xlab = "Education", ylab = "AFQT test score",
            xlim = c(5,20))
title(main = "Income, proportional to circle area")
legend("left", c("Female", "Male"),
       text.col = c(1:2)+3, cex=0.9, bty = "n")
...
**Plot 33 November 18, 2018:** Bubble Plots encoding third variable point size.
...
PlotBubble(x = Height, y = Girth, area = Volume,
           ...
           cex = 0.2, xlim = c(60, 95), ylim = c(5, 30),
           xlab = "Height", ylab = "Girth", 
           main = "Tree Volume (Circle Area) as Function of Height and Girth",
           family = "HersheySerif", font.main = 2, col.main = "darkblue", 
...
**Plot 32 November 17, 2018:** False Color Plots to encode a third dimension with color.
...
**Plot 31 November 15, 2018:** 3D Scatterplot with a prediction plane.
...
# plot
sp3d <- scatterplot3d(Height, Girth, Volume, 
                      pch = 16, highlight.3d = T, 
                      type = "h",
                      main = "3D ScatterPlot with Prediction Plane",
                      cex.axis = 0.7,
                      box = F)
...
**Plot 30 November 7, 2018:** Moving over into multi-variable plots of three or more dimensions, today taking a look at 3D scatter plots using the scatterplot3d package and function. Again, just exploring the lessons and charts in _Graphing Data with R_. The arguments for `scatterplot3d` can be either a matrix or individual vectors x, y, and z. Variable x is plotted on the horizontal axis, y on the diagonal axis, and z on the vertical axis. 
...
scatterplot3d(Height, Girth, Volume,
              ...
              highlight.3d = TRUE,
              cex.axis = 0.7,
              main = "Highlighting & Axis Text Sizing")
...
scatterplot3d(Height, Girth, Volume,
              ...
              type = "h",
              highlight.3d = TRUE,
              main = "Drop Lines Added")

# plot4
scatterplot3d(Height, Girth, Volume,
              pch = 15, lwd = 6,
              color = "cyan4", box = FALSE,
              type = "h", cex.axis = 0.7,
              main = "Bar Plot with Box Removed")
...
**Plot 29 October 23, 2018:**
A look at `corrgram`, a plot related to the scatterplot matrix (see below) that show the linear correlation between two quantitative variables. Again today, working from _Graphing Data with R_.
...
# create correlation matrix between selected variables from church dataset
y = cor(ex1713[, 2:6])
